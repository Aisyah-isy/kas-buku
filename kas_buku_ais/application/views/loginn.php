<html lang="en" class="light-style customizer-hide" dir="ltr" data-theme="theme-default" data-assets-path="<?=base_url("assets/sneat")?>/assets/" data-template="vertical-menu-template-free"><head>
    <meta charset="utf-8">
    ...
    <!-- Helpers -->
    <script src="<?=base_url("assets/sneat")?>/assets/vendor/js/helpers.js"></script><style type="text/css">
            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">Kas Buku</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Login Dulu Kak!👋</h4>
              <p class="mb-4"></p>
